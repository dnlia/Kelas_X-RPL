...
<body>
    <div class="container">
        ...
        <div class="row mt-4">
            <div class="col-md-3">
               <a href="index.php"> <h3>୨ৎ˚⋆Admin Page⊹ ࣪ ˖</h3> </a>
            </div>
                        ...
                        switch ($level) {
                            case 'admin':
                                echo '                    
                                    ...
                                    <li class="nav-item"><a class="nav-link" href="?f=pelanggan&m=select">Pelangganɞ˚‧｡⋆</a></li>
                                    <li class="nav-item"><a class="nav-link" href="?f=order&m=select">Order✧˖°.</a></li>
                                    <li class="nav-item"><a class="nav-link" href="?f=orderdetail&m=select">Order Detail˚୨୧⋆.˚</a></li>
                                    <li class="nav-item"><a class="nav-link" href="?f=user&m=select">User.☘︎ ݁˖</a></li>
                                ';
                                break;
        ...
        <div class="row mt-5">
            ...
            <div class="col">
                <p class="text-center">୨ৎ˚⋆‧₊2025 - copyright@dnli.com⋅ ˚✮</p>
            </div>
